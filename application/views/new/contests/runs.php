<?php
	...
	function showPageNumber($i, $c=0, $cont=NULL, $set=false) {
		...
		if ($i != $current) echo '<li><a href="' . site_url("contests/my_runs/" . $contest->id . "/" . $i) . '">' . $i . '</a></li> ';
		...
		<div id="main">
			<div id="main-container">
				<div id="page-tabs-container">
					<?php
						contest_tabs($contest, $is_logged_in, $current_user, TAB_CONTEST_MYRUNS);
					?>
				</div>
				<div class="clear"></div>
				<div id="page-content">
								...
								<table id="my-runs-list-table" width="100%" class="list">
									<thead>
										<tr>
											...
											<?php if ($current_user->perm_judge) { ?>
											<th width="1%" scope="col"></th>
											<th width="1%" scope="col"></th>
											<?php } ?>
											<th width="1%" scope="col"></th>
									...
									<tbody>
										...
										<tr class="run_row" id="run_<?=$run->id?>">
											...
											<td><center><a href="<?=site_url("users/profile/" . $current_user->id)?>"><?=$current_user->name?></a></center></td>
