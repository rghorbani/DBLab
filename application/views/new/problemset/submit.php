		...
		<div id="main">
			<div id="main-container">
				<div id="page-tabs-container">
					<?php
						problem_tabs($is_logged_in, $current_user, TAB_PROBLEM_SUBMIT, $problem);
					?>
				</div>
				<div class="clear"></div>
				<div id="page-content">
					...
					<div id="problemset_submit" class="shadowed">
						<div class="inner-box">
							<div class="content">
								...
								<form id="submit_form" action="<?=site_url('problemset/submit/' . $problem->code)?>" method="post">
									<ul>
										<li>
										...
										<li>
											...
											<textarea style="display:none;" id="source_code" name="source_code" cols="100" rows="20" onchange="setEditor()"><?=set_value('source_code')?></textarea>
