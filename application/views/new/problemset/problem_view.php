		...
		<div id="main">
			<div id="main-container">
				<div id="page-tabs-container">
					<?php
						problem_tabs($is_logged_in, $current_user, TAB_PROBLEM_VIEW, $problem);
					?>
				</div>
				<div class="clear"></div>
				<div id="page-content">
					...
					<div id="problemset_problem-view" class="shadowed">
						<div class="inner-box">
							<div class="content">
								...
								<a id="submit-btn" href="<?=site_url("problemset/submit/" . $problem->code)?>">Submit</a>
								...
								<p id="controlls"><a href="<?=site_url("admin/edit_problem/" . $problem->code)?>">[Edit]</a></p>
								<?php } ?>
							</div>
						</div>
					</div>
