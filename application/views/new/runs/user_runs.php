<?php
	...
	function showPageNumber($i, $c=0, $id = NULL, $set=false) {
		...
		if ($i != $current) echo '<li><a href="' . site_url("runs/user/" . $uid . "/" . $i) . '">' . $i . '</a></li> ';
		else				echo '<li class="selected">' . $i . '</li> ';
	}
	showPageNumber(0, $current_page, $user->id, true);
?>

			<h1 id="top-title">User Runs</h1>
		</div>
		<div id="main">
			<div id="main-container">
				<div id="page-tabs-container">
					<?php
						user_profile_tabs($is_logged_in, $user, $current_user, TAB_USERPROFILE_RUNS);
					?>
				</div>
				<div class="clear"></div>
				<div id="page-content">
